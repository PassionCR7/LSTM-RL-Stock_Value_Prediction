...
class StockBlockLayer(nn.Module):
    ...
    def spe_seq_cell(self, input):
        ...
        # fft：快速离散傅里叶变换，rfft：去除那些共轭对称的值，减小存储
    ...
    def forward(self, x, mul_L):
        ...
        # gfted shape: torch.Size([32, 4, 1, 140, 12])
        ...
        # igfted shape:  torch.Size([32, 4, 1, 140, 60])

        igfted = torch.sum(igfted, dim=1)
        # igfted shape: torch.Size([32, 1, 140, 60])
...
class Model(nn.Module):
    def __init__(self, units, stack_cnt, time_step, multi_layer, horizon=1, dropout_rate=0.5, leaky_rate=0.2,
        ...
        # windows size, is the length of input sequence
        self.time_step = time_step
    ...
    def forward(self, x):
        ...
        for stack_i in range(self.stack_cnt):
            ...
            # output X: backcast = X - X_hat  ==> torch.Size([32, 1, 140, 12])
